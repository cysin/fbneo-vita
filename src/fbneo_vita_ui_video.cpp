...
FBNeoVitaVideo::FBNeoVitaVideo(UiMain *ui, uint8_t **_pixels, int *_pitch, const c2d::Vector2i &size, const c2d::Vector2i &aspect)
        : C2DUIVideo(ui, _pixels, _pitch, size, aspect) {
}

void FBNeoVitaVideo::updateScaling(bool vertical, bool flip) {

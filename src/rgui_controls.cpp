...
namespace {
    ...
    constexpr ControlItem CONTROL_ITEMS[] = {
        ...
        {PEMUConfig::OptId::JOY_A, "Cross"},
        {PEMUConfig::OptId::JOY_B, "Circle"},
        {PEMUConfig::OptId::JOY_X, "Square"},
        {PEMUConfig::OptId::JOY_Y, "Triangle"},
        {PEMUConfig::OptId::JOY_LT, "L1"},
        {PEMUConfig::OptId::JOY_RT, "R1"},
        {PEMUConfig::OptId::JOY_LB, "L2"},
        {PEMUConfig::OptId::JOY_RB, "R2"},
        {PEMUConfig::OptId::JOY_LS, "L3"},
        {PEMUConfig::OptId::JOY_RS, "R3"},
